...
const terms = {
  ...
  'en-US':
    ...
    '<p>This page sets out the terms of use of visitors to this website. By using this website, you accept all of its terms (including these Terms of Use and the Privacy Policy). A reference in these Terms of Use to ‘we’, ‘us’ or ‘our’ means Tinance Ltd.</p>' +
    ...
    '<p>You may link to this website provided you do so in a way that accurately indicates that the link is to the tinance.io website and is not misleading.</p>' +
    ...
    '<p>If you think any content on this website is inappropriate or unlawful or infringes your rights, please contact us at support@tinance.io</p>' +
    ...
    '<ul>' +
    '<li>You will need to register and create an account in order to access the Tinance platform as a user. When you register as a member and create your profile, you will need to provide us with your email address, and pick a username and password. You must log in using your username and password to access the services.</li>' +
    ...
    '<li>You must be at least 18 years old to sign up for a Tinance account. If you sign up for an account, you warrant that you are at least 18 years old.</li>' +
    '</ul>' +
    'We may suspend or delete your account if:' +
    '<ul>' +
    '<li>we consider that you are using the Tinance platform to scam other users or for any other unlawful purpose;</li>' +
    ...
    '<li>Tinance is required by law to do so;</li>' +
    '<li>there is any change in law that adversely affects Tinance’ operating model or would make it unlawful to continue the service without materially changing the Tinance platform or regulatory licence required to operate; and</li>' +
    '<li>for any other reason in our absolute discretion.</li>' +
    '</ul>' +
    'Once your account is deleted, we destroy any information we hold in relation to it after any legal requirement imposed on Tinance to retain it has expired. After suspension of your account, you are entitled to limited access for the purpose of managing existing trades however you may not open new trades or post to the marketplace.' +
    '</li>' +
    '<li><b>Offers</b>' +
    '<ul>' +
    '<li>Tinance users may post offers to buy or sell cryptocurrencies in exchange for local currencies using the marketplace. Offers on the marketplace are made publicly available, and can be viewed by anyone who accesses the website.</li>' +
    ...
    "<li>Offers displayed on the Tinance website clearly show Tinance's fee for each party. </li>" +
    '<li>Tinance reserves the right to delete offers from the marketplace at its discretion. Generally, it will delete offers if they appear to be unlawful, non-genuine, fraudulent, spam or are otherwise incorrect.</li>' +
    '</ul>' +
    '</li>' +
    '<li><b>Trades</b>' +
    '<ul>' +
    ...
    '<ul>' +
    "<li>the payment of Tinance's fee;</li>" +
    '<li>the process for arbitration set out in these Service Terms;</li>' +
    '</ul>' +
    '</li>' +
    '<li><b>Security</b><br/>' +
    'You must comply with all reasonable security requirements prescribed from time to time by Tinance.' +
    '</li>' +
    '<li><b>Disputes</b><br/>' +
    ...
    '</ul>' +
    'Either party may refer the dispute to Tinance.' +
    '<ul>' +
    '<li>The party referring the dispute to Tinance must give Tinance access to all information required by Tinance to resolve the dispute, including evidence of payments. Tinance will review the evidence and it will direct the cryptocurrency to the party who in Tinance’ reasonable opinion is entitled to own it under the terms of sale.</li>' +
    '<li>Parties must respond to Tinance’ requests for information promptly (and at least within 24 hours). If a party does not respond to a request within that timeframe, Tinance may resolve the escrow in favour of the other party to the dispute.</li>' +
    '<li>The parties agree that except in cases of gross negligence or fraud, Tinance’ decision is final and binding on the parties and there is no appeal from such decision.</li>' +
    '<li>Tinance reserves the right to refuse to resolve a dispute where Tinance, in its sole discretion, considers that:<br>' +
    ...
    'Tinance has a legal obligation to do so; or<br/>' +
    'directing cryptocurrency to a party would cause Tinance to breach any law.<br/><br/>' +
    'Where Tinance exercises its right to refuse to resolve a dispute, Tinance will notify both parties of this. Either party may then apply for a court order resolving the dispute.' +
    '</li>' +
    '<li>If a party provides a copy of a court order to Tinance along with access to a digital signature that allows Tinance limited control of the escrow, Tinance will resolve the escrow in accordance with the court order.</li>' +
    '<li>This process for resolving disputes is incorporated in all contracts between buyers and sellers arranged through Tinance.</li>' +
    '</ul>' +
    '</li>' +
    '<li><b>Tinance Fees</b>' +
    '<ul>' +
    '<li>Tinance fees at time of publishing are a 0.1% fee for the maker (the person who placed the offer listing) and 0.1% for the taker (the person responding to the offer). The fee is charged in cryptocurrency.</li>' +
    '<li>The actual amount is clearly shown when creating or accepting the offer.</li>' +
    '</ul>' +
    '</li>' +
    '<li><b>Taxes</b><br/>' +
    'You are responsible for determining what taxes apply to any trades you conduct with other Tinance users. You must pay for all taxes applicable to all trades in which you participate.<br/>' +
    'You indemnify Tinance for any claim, loss or damage arising from your failure to pay applicable taxes.' +
    '</li>' +
    '<li><b>Risks</b>' +
    '<ul>' +
    '<li>Cryptocurrency transfers are irreversible. If you release or send cryptocurrency to somebody else, it is generally not possible for Tinance, nor yourself, to recover the funds. This also applies to sending cryptocurrency to an incorrect address. You transfer any cryptocurrency at your own risk.</li>' +
    ...
    '</li>' +
    '<li><b>Disclaimer</b>' +
    'Tinance does not facilitate or provide brokerage, exchange, payment, escrow, remittance or merchant services.<br/><br/>' +
    ...
    'You indemnify Tinance and hold Tinance harmless against all loss, claims, actions, liability, damage, costs (including legal fees on a solicitor and client basis), expenses and penalties arising directly or indirectly from any:' +
    '<ul>' +
    '<li>breach by you of these Service Terms;</li>' +
    '<li>unauthorised use of your Tinance account;</li>' +
    '<li>act or omission (including any negligence, unlawful conduct, wilful misconduct or fraud) by you in relation to your use of Tinance’ services;</li>' +
    '<li>third party claim against us in relation to your use of Tinance’ services;</li>' +
    '<li>any action taken by Tinance at your request in respect of your account, trade or dispute;</li>' +
    ...
    '<li>any failure by you to comply with any reasonable recommendation made by Tinance;</li>' +
    ...
    '</ul>' +
    'Except in the case of gross negligence or fraud in resulting a dispute, and to the fullest extent permitted by law, Tinance is not liable for any breach of these Service Terms, or any act or omission (including any negligent act or omission) of Tinance in connection with these Service Terms or any services supplied by Tinance.<br/><br/>' +
    ...
    'You should exercise reasonable caution when reviewing emails and SMSs purporting to originate from Tinance as emails can be vulnerable to phishing, spoofing and additional viruses.' +
    '</li>' +
    ...
    '</li>' +
    '<li><b>Contact</b><br/>' +
    'Please send any questions, comments, issues, or general correspondence via email to support@tinance.io.' +
    '</li>' +
    '</ol>',
  'zh-CN':
